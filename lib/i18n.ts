...
export const translations: Record<Language, Record<string, string>> = {
    en: {
        ...
        'history.tests_registered': 'tests registered locally',
        'history.average': 'Average',
        'history.maximum': 'Maximum',
        'history.minimum': 'Minimum',
        'history.trend': 'Trend',
        'history.latest_tests': 'Latest tests:',
        ...
        'badges.super_downloader': 'Super Downloader',
        'badges.super_downloader_desc': 'Download speed > 300 Mbps',
        'badges.upload_master': 'Upload Master',
        'badges.upload_master_desc': 'Upload speed > 100 Mbps',
        'badges.gaming_beast': 'Gaming Beast',
        'badges.gaming_beast_desc': 'Ping < 10ms and download > 50 Mbps',
        'badges.stability_king': 'Stability King',
        'badges.stability_king_desc': 'Connection stability > 95%',
        'badges.trustworthy': 'Trustworthy',
        'badges.trustworthy_desc': 'Completed 10+ tests without errors',
        'badges.speed_demon': 'Speed Demon',
        'badges.speed_demon_desc': 'Download > 100 Mbps',
        'badges.balanced_connection': 'Balanced Connection',
        'badges.balanced_connection_desc': 'Download and upload > 50 Mbps with ping < 30ms',
        'badges.ranked_top_1000': 'Top 1000 Global',
        'badges.ranked_top_1000_desc': 'Reached top 1000 ranking position',
        'badges.ranked_top_100': 'Top 100 Global',
        'badges.ranked_top_100_desc': 'Reached top 100 ranking position',
        'badges.low_latency_master': 'Master of Low Latency',
        'badges.low_latency_master_desc': 'Jitter < 2ms',

        // Footer
        'footer.tagline_1': 'Show off your WiFi speed and compete in the global ranking',
        'footer.tagline_2': 'Accurate test, reliable results and global competition',
        'footer.navigation': 'Navigation',
        'footer.made_with_love': 'Made with 💙 for you',
    },
    ...
    es: {
        ...
        // Test History
        'history.title': 'Histórico de Pruebas',
        'history.tests_registered': 'pruebas registradas localmente',
        'history.average': 'Promedio',
        'history.maximum': 'Máximo',
        'history.minimum': 'Mínimo',
        'history.trend': 'Tendencia',
        'history.latest_tests': 'Últimas pruebas:',
        'history.clear': '🗑️ Limpiar histórico',
        ...
        'badges.super_downloader': 'Super Descargador',
        'badges.super_downloader_desc': 'Velocidad de descarga > 300 Mbps',
        'badges.upload_master': 'Master de Subida',
        'badges.upload_master_desc': 'Velocidad de subida > 100 Mbps',
        'badges.gaming_beast': 'Bestia Gamer',
        'badges.gaming_beast_desc': 'Ping < 10ms y descarga > 50 Mbps',
        'badges.stability_king': 'Rey de la Estabilidad',
        'badges.stability_king_desc': 'Estabilidad de conexión > 95%',
        'badges.trustworthy': 'Confiable',
        'badges.trustworthy_desc': 'Completó 10+ pruebas sin errores',
        'badges.speed_demon': 'Demonio de la Velocidad',
        'badges.speed_demon_desc': 'Descarga > 100 Mbps',
        'badges.balanced_connection': 'Conexión Balanceada',
        'badges.balanced_connection_desc': 'Descarga y subida > 50 Mbps con ping < 30ms',
        'badges.ranked_top_1000': 'Top 1000 Global',
        'badges.ranked_top_1000_desc': 'Alcanzó posición en top 1000 ranking',
        'badges.ranked_top_100': 'Top 100 Global',
        'badges.ranked_top_100_desc': 'Alcanzó posición en top 100 ranking',
        'badges.low_latency_master': 'Master de Baja Latencia',
        'badges.low_latency_master_desc': 'Jitter < 2ms',

        // Footer
        'footer.tagline_1': 'Presume tu velocidad de WiFi y compite en el ranking mundial',
        'footer.tagline_2': 'Prueba precisa, resultados confiables y competencia global',
        'footer.navigation': 'Navegación',
        'footer.made_with_love': 'Hecho con 💙 para ti',
    },
    ...
    zh: {
        ...
        // Test History
        'history.title': '测试历史',
        'history.tests_registered': '本地注册测试',
        'history.average': '平均值',
        'history.maximum': '最大值',
        'history.minimum': '最小值',
        'history.trend': '趋势',
        'history.latest_tests': '最新测试:',
        'history.clear': '🗑️ 清除历史',
        ...
        'badges.super_downloader': '超级下载机',
        'badges.super_downloader_desc': '下载速度 > 300 Mbps',
        'badges.upload_master': '上传大师',
        'badges.upload_master_desc': '上传速度 > 100 Mbps',
        'badges.gaming_beast': '游戏兽王',
        'badges.gaming_beast_desc': 'Ping < 10ms 且下载 > 50 Mbps',
        'badges.stability_king': '稳定之王',
        'badges.stability_king_desc': '连接稳定性 > 95%',
        'badges.trustworthy': '值得信赖',
        'badges.trustworthy_desc': '完成 10+ 次无错误测试',
        'badges.speed_demon': '速度恶魔',
        'badges.speed_demon_desc': '下载 > 100 Mbps',
        'badges.balanced_connection': '平衡连接',
        'badges.balanced_connection_desc': '下载和上传 > 50 Mbps，Ping < 30ms',
        'badges.ranked_top_1000': '全球前1000名',
        'badges.ranked_top_1000_desc': '达到排名前1000',
        'badges.ranked_top_100': '全球前100名',
        'badges.ranked_top_100_desc': '达到排名前100',
        'badges.low_latency_master': '低延迟大师',
        'badges.low_latency_master_desc': 'Jitter < 2ms',

        // Footer
        'footer.tagline_1': '展示你的WiFi速度并在全球排名中竞争',
        'footer.tagline_2': '精确测试、可靠结果和全球竞争',
        'footer.navigation': '导航',
        'footer.made_with_love': '用❤️为你创建',
    },
    ...
    hi: {
        ...
        'history.tests_registered': 'स्थानीय रूप से पंजीकृत परीक्षण',
        'history.average': 'औसत',
        'history.maximum': 'अधिकतम',
        'history.minimum': 'न्यूनतम',
        'history.trend': 'प्रवृत्ति',
        'history.latest_tests': 'नवीनतम परीक्षण:',
        'history.clear': '🗑️ इतिहास साफ करें',
        ...
        'badges.super_downloader': 'सुपर डाउनलोडर',
        'badges.super_downloader_desc': 'डाउनलोड गति > 300 Mbps',
        'badges.upload_master': 'अपलोड मास्टर',
        'badges.upload_master_desc': 'अपलोड गति > 100 Mbps',
        'badges.gaming_beast': 'गेमिंग जानवर',
        'badges.gaming_beast_desc': 'Ping < 10ms और डाउनलोड > 50 Mbps',
        'badges.stability_king': 'स्थिरता राजा',
        'badges.stability_king_desc': 'कनेक्शन स्थिरता > 95%',
        'badges.trustworthy': 'विश्वसनीय',
        'badges.trustworthy_desc': '10+ त्रुटि रहित परीक्षण पूर्ण किए',
        'badges.speed_demon': 'गति दानव',
        'badges.speed_demon_desc': 'डाउनलोड > 100 Mbps',
        'badges.balanced_connection': 'संतुलित कनेक्शन',
        'badges.balanced_connection_desc': 'डाउनलोड और अपलोड > 50 Mbps, Ping < 30ms',
        'badges.ranked_top_1000': 'शीर्ष 1000 विश्व',
        'badges.ranked_top_1000_desc': 'शीर्ष 1000 रैंकिंग तक पहुंचा',
        'badges.ranked_top_100': 'शीर्ष 100 विश्व',
        'badges.ranked_top_100_desc': 'शीर्ष 100 रैंकिंग तक पहुंचा',
        'badges.low_latency_master': 'कम लेटेंसी मास्टर',
        'badges.low_latency_master_desc': 'Jitter < 2ms',

        // Footer
        'footer.tagline_1': 'अपनी WiFi गति दिखाएं और वैश्विक रैंकिंग में प्रतिस्पर्धा करें',
        'footer.tagline_2': 'सटीक परीक्षण, विश्वसनीय परिणाम और वैश्विक प्रतिस्पर्धा',
        'footer.navigation': 'नेविगेशन',
        'footer.made_with_love': 'आपके लिए ❤️ से बनाया गया',
    },
    ...
    fr: {
        ...
        'history.tests_registered': 'tests enregistrés localement',
        'history.average': 'Moyenne',
        'history.maximum': 'Maximum',
        'history.minimum': 'Minimum',
        'history.trend': 'Tendance',
        'history.latest_tests': 'Derniers tests:',
        ...
        'badges.super_downloader': 'Super téléchargeur',
        'badges.super_downloader_desc': 'Vitesse de téléchargement > 300 Mbps',
        'badges.upload_master': 'Maître de l\'envoi',
        'badges.upload_master_desc': 'Vitesse d\'envoi > 100 Mbps',
        'badges.gaming_beast': 'Bête de jeu',
        'badges.gaming_beast_desc': 'Ping < 10ms et téléchargement > 50 Mbps',
        'badges.stability_king': 'Roi de la stabilité',
        'badges.stability_king_desc': 'Stabilité de connexion > 95%',
        'badges.trustworthy': 'Digne de confiance',
        'badges.trustworthy_desc': '10+ tests sans erreur complétés',
        'badges.speed_demon': 'Démon de vitesse',
        'badges.speed_demon_desc': 'Téléchargement > 100 Mbps',
        'badges.balanced_connection': 'Connexion équilibrée',
        'badges.balanced_connection_desc': 'Téléchargement et envoi > 50 Mbps avec ping < 30ms',
        'badges.ranked_top_1000': 'Top 1000 Mondial',
        'badges.ranked_top_1000_desc': 'Atteint la position top 1000 du classement',
        'badges.ranked_top_100': 'Top 100 Mondial',
        'badges.ranked_top_100_desc': 'Atteint la position top 100 du classement',
        'badges.low_latency_master': 'Maître de la faible latence',
        'badges.low_latency_master_desc': 'Gigue < 2ms',

        // Footer
        'footer.tagline_1': 'Montrez votre vitesse WiFi et concourez dans le classement mondial',
        'footer.tagline_2': 'Test précis, résultats fiables et compétition mondiale',
        'footer.navigation': 'Navigation',
        'footer.made_with_love': 'Fait avec ❤️ pour vous',
    }
}
