        ...
        <div className="flex items-center justify-between">
          ...
          <Link href="/" className="flex items-center space-x-3 group">
            <motion.div
              ...
              className="w-12 h-12 rounded-xl bg-gradient-to-br from-blue-500/30 to-purple-500/30 flex items-center justify-center group-hover:from-blue-500/50 group-hover:to-purple-500/50 transition-all duration-300 shadow-lg shadow-blue-500/20"
            >
              <span className="text-3xl">⚡</span>
            </motion.div>
            <div>
              <h1 className="text-2xl font-black bg-gradient-to-r from-blue-100 via-white to-blue-200 bg-clip-text text-transparent tracking-tight">
                WifiTOP
              </h1>
              <p className="text-xs text-gray-400 font-semibold tracking-wide">Speedtest Ranking Global</p>
            </div>
          </Link>
